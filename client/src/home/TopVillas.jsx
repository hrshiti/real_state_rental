  ...
  return (
    <div className="w-screen h-full bg-[#F8EFE2] flex flex-col justify-center text-black items-center   ">
      <div className="flex flex-col gap-12 w-full max-w-[1536px] text-center">
        {/* Heading Section */}
        <div className="w-screen max-w-[1257px] mx-auto mt-16">
          <h1 className="w-screen max-w-[596px] h-[72px] font-[Rufina] font-bold text-6xl text-[#181d24] mx-auto  sm:text-5xl md:text-6xl">
            Top pick villas
          </h1>
          <p className="w-screen max-w-[757px] h-[48px] font-[Raleway] font-medium text-base text-[#181d24] mx-auto pt-[35px]  sm:text-base md:text-lg">
        ...
        {/* Cards Section */}
        <div className="w-screen grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 mb-20 gap-10  md:ml-0 sm:ml-0 pt-[44px]">
